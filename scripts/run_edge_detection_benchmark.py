...
def main():
    ...
    parser.add_argument("--benchmark", choices=["edge_detection", "fft", "fft_benchmark", "all"], default="all", help="Benchmark to run (default: all)")
    ...
    if args.benchmark == "all":
        benchmarks_to_run = ["edge_detection", "fft_benchmark"]
